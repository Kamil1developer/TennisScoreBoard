# Review на реализацию от [@kamulhus](https://github.com/Kamil1developer/TennisScoreBoard) проекта [Табло теннисного матча](https://zhukovsd.github.io/java-backend-learning-course/projects/tennis-scoreboard/)
